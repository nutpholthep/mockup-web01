...
const MedicalHistory = () => {
  ...
  const filteredData = mockData.filter((patient) =>
    patient.hn.toLowerCase().includes(filter.toLowerCase())
  );
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b">
                ...
                >
                  <div className="flex items-center gap-2">HN</div>
                </th>
                <th
                  className="p-4 text-left font-medium text-gray-500 cursor-pointer"
                  onClick={() => handleSort("name")}
                >
                  <div className="flex items-center gap-2">ชื่อ-นามสกุล</div>
                </th>
                <th className="p-4 text-left font-medium text-gray-500">เพศ</th>
                <th className="p-4 text-left font-medium text-gray-500">อายุ</th>
                  ...
                  >
                    ...
                    <td className="p-4">
                      <div className="flex gap-2">
                        ...
                        >
                          {expandedPatient === patient.hn ? (
                            <p className="flex justify-center items-center p-2 outline outline-1 outline-emerald-500 rounded-xl space-x-2">
                              {" "}
                              ดูประวัติ <ChevronUp size={20} />
                            </p>
                          ) : (
                            <p className="flex justify-center items-center p-2 outline outline-1 outline-emerald-500 rounded-xl space-x-2">
                              {" "}
                              ดูประวัติ <ChevronDown size={20} />
                            </p>
                          )}
                        </button>
                      </div>
